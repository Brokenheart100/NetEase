...
namespace NetEase.Services
{
    ...
    public class PlayerService
    {
        ...
        public void UpdateProgress(TimeSpan currentTime, TimeSpan totalTime)
        {
            ...
            WeakReferenceMessenger.Default.Send(new ProgressUpdatedMessage(currentTime, totalTime));
        }
        ...
        public void TogglePlayPause()
        {
            ...
            WeakReferenceMessenger.Default.Send(new PlaybackStatusChangedMessage(CurrentStatus));
        }
        ...
        public static void SetVolume(double newVolume)
        {
            ...
            WeakReferenceMessenger.Default.Send(new VolumeChangedMessage(Math.Clamp(newVolume, 0.0, 1.0)));
        }
        ...
        public static void Seek(double percentage)
        {
            ...
            WeakReferenceMessenger.Default.Send(new SeekRequestedMessage(percentage));
        }
        ...
        private void RequestPlay(Song songToPlay)
        {
            ...
            WeakReferenceMessenger.Default.Send(new CurrentSongChangedMessage(CurrentSong));
            WeakReferenceMessenger.Default.Send(new PlaybackStatusChangedMessage(CurrentStatus));
            WeakReferenceMessenger.Default.Send(new PlayRequestedMessage(CurrentSong));
        }
    }
}